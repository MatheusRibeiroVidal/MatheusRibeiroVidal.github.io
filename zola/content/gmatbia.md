+++
title = "GMAT Data Insights – Mock Test"
date = "2026-05-02"
updated = "2026-05-02"
[taxonomies]
tags=["gmat", "data-insights", "mock-test"]
[extra]
comment = true
+++
...
![Internet Survey on Depression Treatments](https://s3.amazonaws.com/wmx-api-production/courses/61212/images/GID0829.gif)
...
**Sub-question 3:** In the columns, select **Acceptable** for each detail that would make the new road acceptable under the standards provided by _both_ the economist and the ecologist. Otherwise, select **Not acceptable**.
...
**Email 1** — January 15, 10:46 a.m. _(from administrator)_
...
**Email 2** — January 15, 11:12 a.m. _(from project coordinator, in response to Email 1)_
...
**Email 3** — January 15, 1:54 p.m. _(from administrator, in response to Email 2)_
...
**Question 1** — [Source](https://gmatclub.com/forum/the-graphic-displays-results-of-an-internet-survey-on-the-effectivenes-311647.html)
...
**Question 2** — [Source](https://gmatclub.com/forum/the-table-shows-the-number-of-businesses-and-jobs-within-each-economic-330277.html)
...
**Question 3** — [Source](https://gmatclub.com/forum/the-table-displays-data-on-brazilian-agricultural-products-in-311329.html)
...
**Question 4** — [Source](https://gmatclub.com/forum/for-zoologists-studying-the-behavior-of-certain-species-of-birds-the-305530.html)
...
|Must NOT happen|**C) Establishing nests** — The passage explicitly states that birds abandon the morefa _to establish their nests_ elsewhere, making nest-building incompatible with the morefa by definition.|Hard|

> **Common trap:** Option B (occupying the location multiple times) is tempting because the passage says "some species repeatedly return." However, the key word is _some_ — not all species do this, so it cannot be a _required_ condition.

---

**Question 5** — [Source](https://gmatclub.com/forum/loan-x-has-a-principal-of-10-000x-and-a-yearly-simple-interest-rate-o-157507.html)
...
**Question 6** — [Source](https://gmatclub.com/forum/do-expenditures-on-road-construction-projects-represent-good-investmen-329011.html)
...
|The economist and the ecologist are both concerned with the criteria on which community planners base decisions.|**Yes** — Both passages explicitly address what planners _should_ evaluate before proceeding with a road project.|Medium|
...
**Question 7** — [Source](https://gmatclub.com/forum/yesterday-was-the-deadline-for-our-receipt-of-completed-surveys-from-322602.html)
...
|The administrator is willing to accept some risk of exceeding the budget for compensating participants.|**Yes** — The administrator says "we will need to _try_ not to exceed" the budget, implying the possibility of exceeding it is accepted.|V. Hard|

---

**Question 8** — [Source](https://gmatclub.com/forum/the-flowchart-represents-a-mathematical-algorithm-that-takes-two-posit-136228.html)
...
**Question 9** — [Source](https://gmatclub.com/forum/a-physician-has-instructed-a-patient-with-a-strong-allergic-reaction-355572.html)
...
**Question 10** — [Source](https://gmatclub.com/forum/natalya-put-14-blue-marbles-14-red-marbles-and-no-other-marbles-into-329396.html)
